...
export const WORD_LIBRARY: WordTrial[] = [
  ...
  { word: 'HARBOR', syllables: 2, options: ['DOCK', 'HAWK', 'MARINA'], answers: { meaning: 'DOCK', letter: 'HAWK', syllables: 'MARINA' } },
  ...
  { word: 'MAGNET', syllables: 2, options: ['STEEL', 'MOLE', 'COMPASS'], answers: { meaning: 'STEEL', letter: 'MOLE', syllables: 'COMPASS' } },
  ...
  { word: 'CRATER', syllables: 2, options: ['HOLE', 'CLAW', 'BASIN'], answers: { meaning: 'HOLE', letter: 'CLAW', syllables: 'BASIN' } },
  ...
  { word: 'DRUM', syllables: 1, options: ['RHYTHM', 'DINNER', 'BEAT'], answers: { meaning: 'RHYTHM', letter: 'DINNER', syllables: 'BEAT' } },
